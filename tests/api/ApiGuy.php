<?php //[STAMP] 479e1c4d5f547f2165db1b3f6c4efb55
...
use app\tests\_helpers\FixtureHelper;
use app\tests\_helpers\ApiHelper;
...
class ApiGuy extends \Codeception\Actor
{
     ...
     *
     * @inheritdoc
     * @see \app\tests\_helpers\FixtureHelper::fixtures()
     */
    public function fixtures() {
        return $this->scenario->runStep(new \Codeception\Step\Action('fixtures', func_get_args()));
    }
     ...
     *
     *
     * @see \app\tests\_helpers\ApiHelper::grabJsonResponse()
     */
    public function grabJsonResponse() {
        return $this->scenario->runStep(new \Codeception\Step\Action('grabJsonResponse', func_get_args()));
    }
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \app\tests\_helpers\ApiHelper::seeEquals()
     */
    public function canSeeEquals($expected, $actual, $message = null) {
     ...
     * @see \app\tests\_helpers\ApiHelper::seeEquals()
     */
    public function seeEquals($expected, $actual, $message = null) {
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \app\tests\_helpers\ApiHelper::seeArrayHasKey()
     */
    public function canSeeArrayHasKey($key, $array, $message = null) {
        return $this->scenario->runStep(new \Codeception\Step\ConditionalAssertion('seeArrayHasKey', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \app\tests\_helpers\ApiHelper::seeArrayHasKey()
     */
    public function seeArrayHasKey($key, $array, $message = null) {
        return $this->scenario->runStep(new \Codeception\Step\Assertion('seeArrayHasKey', func_get_args()));
    }
}
